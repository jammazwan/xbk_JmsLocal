...
Functionality: **_JMS messaging to a local VM only_**
...
Git clone the xbk_JmsLocal project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbk_JmsLocal.git
cd xbk_JmsLocal
mvn install -DskipTests

```

You man now import xbk_JmsLocal into your IDE.
...
_run XbkTest, also see NOTES.md_
